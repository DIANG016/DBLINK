...
app.get('/user/:id', authUser, getAnonymousUsersController); //nos da información de un usuario
...
app.get('/link/:id', authUser, getSingleLinkController, ); //Devuelvo un link
